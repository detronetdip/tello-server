...
export namespace Prisma {
  ...
  */
  ...
  export type CommentCountOutputTypeGetPayload<S extends boolean | null | undefined | CommentCountOutputTypeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  export type userGetPayload<S extends boolean | null | undefined | userArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'following' ? Array < friendsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'followers' ? Array < friendsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'like' ? Array < likeGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'following' ? Array < friendsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'followers' ? Array < friendsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'like' ? Array < likeGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type friendsGetPayload<S extends boolean | null | undefined | friendsArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'user' ? userGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof friends ? friends[P] : never
  } 
      : friends
  ...
  export interface friendsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    /**
     * Find one Friends that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   */
  export type friendsFindUniqueOrThrowArgs = friendsFindUniqueArgsBase
      

  /**
   * friends: findFirstOrThrow
   */
  export type friendsFindFirstOrThrowArgs = friendsFindFirstArgsBase
  ...
  export type commentGetPayload<S extends boolean | null | undefined | commentArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'other_comment' ? Array < commentGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'other_comment' ? Array < commentGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type likeGetPayload<S extends boolean | null | undefined | likeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? like :
    S extends undefined ? never :
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'post' ? postGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'user' ? userGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof like ? like[P] : never
  } 
      : like
  ...
  export type notificationsGetPayload<S extends boolean | null | undefined | notificationsArgs, U = keyof S> =
    ...
    : S extends { select: any } & (notificationsArgs | notificationsFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? userGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof notifications ? notifications[P] : never
  } 
      : notifications
