...
__name2(getDmmfNodeAPI, "getDmmfNodeAPI");
...
__name2(getDmmfBinary, "getDmmfBinary");
...
__name2(addMissingOpenSSLInfo, "addMissingOpenSSLInfo");
function warnOnDeprecatedFeatureFlag(previewFeatures) {
  const getMessage = /* @__PURE__ */ __name2((flag) => `${import_chalk.default.blueBright("info")} The preview flag "${flag}" is not needed anymore, please remove it from your schema.prisma`, "getMessage");
...
__name2(warnOnDeprecatedFeatureFlag, "warnOnDeprecatedFeatureFlag");
