 ...
 */
declare type ContextContributor<Context, NewContext> = (ctx: Context) => NewContext;
/**
 * Test context contributor. Mocks console.error with a Jest spy before each test.
 */
export declare const jestConsoleContext: ContextContributorFactory<{}, BaseContext, {
    mocked: {
